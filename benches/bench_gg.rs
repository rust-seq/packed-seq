...
// }
#[library_benchmark]
#[benches::with_setup(args = [100, 1000, 1000000], setup=PackedSeqVec::random)]
fn par_iter_bp(seq: PackedSeqVec) {
    let len = seq.len();
    let rep = 1000_000_000 / len;
...
library_benchmark_group!(
    name = benches_group;
    benchmarks = par_iter_bp
);
gungraun::main!(library_benchmark_groups = benches_group);
